...
const NearestCard = () => {
  return (
    <section className="mx-auto flex h-card-md w-card flex-col justify-between rounded-large bg-neutral p-6">
      <div className="space-y-5">
        <h4 className="font-bold">Gần bạn nhất</h4>

        <p className="body-4">
          Gồm những sân thể thao được đặt nhiều nhất khu vực của bạn trong tháng
          này.
        </p>
      </div>
      <Link
